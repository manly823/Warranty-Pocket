...
final class PocketManager: ObservableObject {
    ...
    private static var sampleWarranties: [WarrantyItem] {
        ...
        return [
            WarrantyItem(name: "Laptop Pro 14\"", store: "Tech Store", category: .electronics,
                         purchaseDate: monthsAgo(8), warrantyMonths: 12, purchasePrice: 1999.00,
                         notes: "Space gray, high-performance chip, base model"),
            WarrantyItem(name: "55\" OLED TV", store: "Electronics Mart", category: .electronics,
            ...
            WarrantyItem(name: "Cordless Stick Vacuum", store: "Home Appliance Store", category: .appliances,
                         purchaseDate: monthsAgo(3), warrantyMonths: 24, purchasePrice: 749.00,
                         notes: "Cordless with laser detect head attachment"),
            WarrantyItem(name: "Office Desk 140x65", store: "Furniture Outlet", category: .furniture,
                         purchaseDate: monthsAgo(24), warrantyMonths: 120, purchasePrice: 199.00,
                         notes: "White finish, 140x65 cm, home office setup"),
            WarrantyItem(name: "Smart Watch Pro", store: "Tech Store", category: .electronics,
                         purchaseDate: monthsAgo(11), warrantyMonths: 12, purchasePrice: 799.00,
                         notes: "Titanium case, sport band — warranty ending soon!"),
            WarrantyItem(name: "Impact Drill 18V", store: "Hardware Depot", category: .tools,
                         purchaseDate: monthsAgo(6), warrantyMonths: 36, purchasePrice: 189.00,
                         notes: "18V cordless, 2 batteries and charger included"),
            WarrantyItem(name: "Running Shoes", store: "Sports Shop", category: .clothing,
                         purchaseDate: monthsAgo(5), warrantyMonths: 6, purchasePrice: 130.00,
                         notes: "Size 10, white/black colorway"),
            WarrantyItem(name: "Winter Expedition Parka", store: "Fashion Gallery", category: .clothing,
                         purchaseDate: monthsAgo(9), warrantyMonths: 12, purchasePrice: 1150.00,
                         notes: "Black, size M, lifetime craftsmanship warranty"),
            WarrantyItem(name: "AGM Car Battery", store: "Auto Parts Store", category: .automotive,
                         purchaseDate: monthsAgo(18), warrantyMonths: 36, purchasePrice: 185.00,
                         notes: "Group 48, free replacement in first 24 months"),
            WarrantyItem(name: "Kitchen Blender", store: "Cookware Shop", category: .appliances,
                         purchaseDate: monthsAgo(13), warrantyMonths: 12, purchasePrice: 99.00,
                         notes: "5-speed, red — warranty may have expired"),
            WarrantyItem(name: "Noise Canceling Headphones", store: "Audio Store", category: .electronics,
                         purchaseDate: monthsAgo(5), warrantyMonths: 12, purchasePrice: 349.00,
                         notes: "Over-ear, silver finish, active noise canceling"),
            WarrantyItem(name: "Ergonomic Office Chair", store: "Office Furniture Co", category: .furniture,
