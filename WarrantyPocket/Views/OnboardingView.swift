...
struct OnboardingView: View {
    ...
    private let pages: [(icon: String, title: String, body: String, color: Color)] = [
        ("shield.fill", "Protect Your Purchases",
         ...
         Theme.accent),
        ("photo.on.rectangle.angled", "Attach Receipt Photos",
         "Save a photo of any receipt alongside your warranty. Optional text recognition can help pre-fill some fields for convenience.",
         Theme.secondary),
